...
<div class="portlet-body">
	...
	<table class="table table-striped table-bordered table-hover" id="sample_1">
		...
		<tbody>
			<?php foreach ($getpurchase as $purchase) : ?>
				<tr class="odd gradeX">
					<td><input type="checkbox" class="checkboxes" value="<?= $purchase['id']; ?>" /></td>
					<td> <?= $purchase['no_sku']; ?></td>
					<td> <?= $purchase['tanggal_beli']; ?></td>
					<td><span class="label label-sm label-danger"><?= $purchase['qty']; ?></span></td>
